...
public class CustomUiDevice {
    ...
    public Object findObject(Object selector) throws ClassNotFoundException, ElementNotFoundException, InvalidSelectorException, UiAutomator2Exception {
        ...
        if (selector instanceof BySelector) {
            node = (AccessibilityNodeInfo) invoke(METHOD_FIND_MATCH, ByMatcher, Device.getInstance().getUiDevice(), selector, getWindowRoots());
            ...
            UiObject uiObject = Device.getInstance().getUiDevice().findObject((UiSelector) selector);
            if(uiObject.exists()) {
                return uiObject;
            }
            return null;
        ...
        try {
            ...
            Object[] constructorParams = {Device.getInstance().getUiDevice(), selector, node};
    ...
    public List<Object> findObjects(Object selector) throws ClassNotFoundException, InvalidSelectorException, UiAutomator2Exception {
        ...
        if (selector instanceof BySelector) {
            ...
            Object nodes = invoke(METHOD_FIND_MATCHS, ByMatcher, Device.getInstance().getUiDevice(), selector, getWindowRoots());
