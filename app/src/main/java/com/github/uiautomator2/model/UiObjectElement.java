...
import com.github.uiautomator2.utils.API;
...
public class UiObjectElement implements AndroidElement {
    ...
    public boolean SwipeOrientation(String direction, int steps) throws UiObjectNotFoundException{
        ...
        switch (directionEnum) {
            case UP:
                result = element.swipeUp(steps);
                break;
            case DOWN:
                result = element.swipeDown(steps);
                break;
            case LEFT:
                result = element.swipeLeft(steps);
                break;
            case RIGHT:
                result = element.swipeRight(steps);
                break;
            default:
                result = false;
                break;
